...
# installed.
TCL_PREFIX='H:/bank_churn_prediction/venvst\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='H:/bank_churn_prediction/venvst\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='H:/bank_churn_prediction/venvst\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IH:/bank_churn_prediction/venvst\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LH:/bank_churn_prediction/venvst\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='H:/bank_churn_prediction/venvst\Library\lib\tclstub86.lib'
